# Copyright (c) 2022, Pipal ERP and Contributors
...
def get_days_in_month(date):
    ...
    :param date: A date object (datetime.date or datetime.datetime)
    :return: Number of days in the month of the provided date.
    """
...
#     years_diff = ed_date.year - st_date.year
#     months_diff = ed_date.month - st_date.month
...
#         days_fraction = (ed_date.day - st_date.day) / 30.0
#     else:
#         total_months_diff -= 1
#         days_in_previous_month = (ed_date.replace(day=1) - timedelta(days=1)).day
#         days_fraction = (ed_date.day + (days_in_previous_month - st_date.day + 1)) / 30.0
    
#     # Combine the month difference and the fraction of the month
#     return total_months_diff + days_fraction
