...
class EmployeeTaxExemptionDeclaration(Document):
	...
	def set_total_declared_amount(self):
		...
		# print("income_tax_slab",income_tax_slab)
		# print("self.is_new_regime",self.is_new_regime)
	...
	def calculate_hra_exemption(self):
		...
		if self.get("monthly_house_rent") and not self.is_new_regime:
