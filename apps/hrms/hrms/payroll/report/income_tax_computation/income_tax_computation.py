...
class IncomeTaxComputationReport:
    ...
    def get_employee_filters(self):
        if not self.filters.get("employee"):
            frappe.throw(_("Employee is mandatory to view this report"))
    ...
    def get_tax_exemptions(self, source):
        # Get category-wise exemptions based on submitted proofs or declarations
